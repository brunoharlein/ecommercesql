  ...
  <div class="form-group col-md-4">
    ...
    <div class="form-group col-md-4">
        ...
        <select id="inputState" class="form-control" name="user_status">
          <option <?php if(isset($_SESSION["answers"]) && $_SESSION["answers"]["user_status"] === "admin"){echo "selected='selected'";} ?>>admin</option>
          <option <?php if(isset($_SESSION["answers"]) && $_SESSION["answers"]["user_status"] === "user"){echo "selected='selected'";} ?>>user</option>
          <option <?php if(isset($_SESSION["answers"]) && $_SESSION["answers"]["user_status"] === "writer"){echo "selected='selected'";} ?>>writer</option>
        </select>
      </div>
